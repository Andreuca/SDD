...
Nod* inserareSfarsitLista(Nod* p, Student s) {
	Nod* nou;
	nou = (Nod*)malloc(sizeof(Nod) * 1); //alocare nod nou
...
// Determinare numar noduri in lista

// Dezalocare lista

// Interschimb noduri adiecente lista simpla (cu modificare adrese de legatura -> next)

void main() {
	Nod* prim = NULL;
	Student s;

	// De consultat un fisier
	while (fgets(...)) {
